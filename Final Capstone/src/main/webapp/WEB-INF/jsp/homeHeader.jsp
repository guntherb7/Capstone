...
<c:url var="siteCss" value="/css/homeSite.css" />
...
<div class="navigation">
	...
	<div class="header-image">
		<img src="<%=request.getContextPath()%>/img/Preview.jpg">
	...
	<a class="nav-link" href="${editMyBreweryBeers}">Edit My Beers</a>	 --%>
		...
		<div class="marketing-message">
			<div class="vertical-margin">
				<h2>
					<span>Explore Columbus breweries, and beers.</span>
				</h2>
				<p>
					<span>Not sure where to grab a pint? Brewery Finder shows
						you popular bars and venues nearby and available taps.</span>
				</p>
			</div>
		</div>
	</nav>
